      ...
      <div className='flex '>
        ...
        <div className='flex flex-col '>
            ...
            <div className="flex  justify-end max-w-7xl">
                    {firstHalf.map((card, index) => (
                        <div key={index} className="w-full sm:w-1/2  lg:w-60 p-2 lg:h-80">
                            <div className="bg-white shadow-md rounded-lg overflow-hidden lg:flex-col h-full p-8" data-aos="zoom-out">
         ...
         {secondHalf.map((card, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-60  p-2 lg:h-80">
            <div className="bg-white shadow-md rounded-lg overflow-hidden flex flex-col h-full p-8" data-aos="zoom-out">
